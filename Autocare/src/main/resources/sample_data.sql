-- Sample data for Germantown AutoCare
-- This is automatically inserted on first application startup
...
-- APPOINTMENTS (Employee_ID optional — assigned technician or advisor)
